                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="input-group mb-6">
                                        ...
                                        <input type="text" name="texto" id="" class="form-control" placeholder="Buscar Categoría" value="{{$texto}}" aria-label="Recipient's username" aria-describedby="button-addon2">
